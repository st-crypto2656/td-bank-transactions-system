...
After a user completes their session, the screen is cleared and the program accepts input
from the next user. The system supports up to 10 users, as specified in the program
requirements.
